                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center">
                            ...
                            @if ($order_have_edits)
                                <a href="{{ route('moderator.order.order_edits', $order->id) }}" class="link-danger link-offset-2 text-decoration-underline link-underline-opacity-25 link-underline-opacity-100-hover ml-2" target="blank">see order edits</a>
                            @endif
                        </div>
                    </div>
                </div>
