                        ...
                        <div class="card" id="orderList">
                            <div class="card-header border-0">
                                <div class="row align-items-center gy-3">
                                    <div class="col-sm">
                                        <h5 class="card-title mb-0">Confirmation Team Orders</h5>
                                    </div>
                                        ...
                                        <div class="col-xxl-2 col-sm-4">
                                            <div>
                                                <select class="form-control" wire:model="team_member" id="idStatus">
                                                    ...
                                                    @foreach ($confirmation_team as $member)
                            ...
                            <div class="card-body pt-0 mt-3">
                                <div>
                                    <div class="table-responsive table-card mb-1">
                                        <table class="table table-nowrap align-middle table-primary" id="orderTable">
