                        ...
                        <div class="card" id="orderList">
                            <div class="card-header border-0">
                                <div class="row align-items-center gy-3">
                                    <div class="col-sm">
                                        <h5 class="card-title mb-0">Shipping Team Orders</h5>
                                    </div>
                                ...
                                <form wire:submit="filterOrders">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-xxl-2 col-sm-4">
                                            <div>
                                                <select class="form-control" wire:model="team_member" id="idStatus">
                                                    <option value="">All members</option>
                                                    @foreach ($shipping_team as $member)
                                                        <option value="{{ $member->moderator_id }}">{{ $member->moderator->name }}</option>
                                                    @endforeach
                            ...
                            <div class="card-body pt-0 mt-3">
                                <div>
                                    <div class="table-responsive table-card mb-1">
                                        <table class="table table-bordered table-nowrap align-middle table-striped-columns" id="orderTable">
                                            ...
                                            <tbody class="list form-check-all">
                                                @foreach ($orders as $order)          
                                                    <tr wire:key="{{ $order->id }}">
                                                        ...
                                                        <td class="id"><a href="{{ route('order.show', $order->id) }}" class="fw-medium link-primary"> {{ $order->id }}</a></td>
                                                        ...
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="{{ route('moderator.team_leader_order.show', $order->id) }}" class="link-primary fs-15"><i class="ri-eye-fill"></i></a>
                                                            </div>
