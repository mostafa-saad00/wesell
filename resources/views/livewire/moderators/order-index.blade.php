                                ...
                                <form wire:submit="filterOrders">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-xxl-3 col-sm-6">
                                            <div>
                                                <input type="date" wire:model="date_range" class="form-control" id="date-picker-input" placeholder="Select date">
                                            </div>
                                        </div>
                                                    ...
                                                    <tr wire:key="{{ $order->id }}">
                                                        ...
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="{{ route('moderator.order.show', $order->id) }}" class="link-primary fs-15"><i class="ri-eye-fill"></i></a>
                                                            </div>
