                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center">
                                <h4 class="mb-sm-0">Order Confirmation </h4>

                                @if ($order_have_edits)
                                    <a href="{{ route('moderator.order.order_edits', $moderator_order->id) }}" class="link-danger link-offset-2 text-decoration-underline link-underline-opacity-25 link-underline-opacity-100-hover ml-2" target="blank">see order edits</a>
                                @endif
                            </div>
                        ...
                        <div class="col-xl-8">
                                ...
                                <div class="card-body">
                                    <div class="profile-timeline">
                                        <div class="accordion accordion-flush" id="accordionFlushExample">
                                            ...
                                            @foreach ($moderator_order->order_status_histories as $status)
                            ...
                            <div class="row align-items-center gy-3">
                                <div class="col-sm">
                                    ...
                                    @if (!$order_not_responding_maximum_times)

                                        <button type="button" class="btn btn-soft-dark" data-bs-toggle="modal" data-bs-target="#staticBackdrop4"><i class="mdi mdi-arrange-send-backward align-middle me-1"></i> Not responding</button>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body text-center p-5">
                                                        ...
                                                        <div class="mt-4">
                                                            <h4 class="mb-3" style="font-size: 16px; font-weight: 600">Customer not responding</h4>
                                                            <p class="text-muted mb-4"> Are you sure?</p>
                                                            <div class="hstack gap-2 justify-content-center">
                                                                <button type="button" class="btn btn-link link-dark fw-medium" data-bs-dismiss="modal"><i class="ri-close-line me-1 align-middle"></i> Close</button>
                                                                <button type="button" wire:click="notRespondingOrder" class="btn btn-dark">delay for tomorrow</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-sm-auto">
                                    <div class="d-flex gap-1 flex-wrap">
                                        <button type="button" wire:click="confirmOrder" class="btn btn-success btn-label right ms-auto"><i class="ri-arrow-right-line label-icon align-bottom fs-16 ms-2"></i> Confirm</button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-unstyled mb-0 vstack gap-3">
                                            ...
                                            @if ($edit_order_ability)
                                                <div class="text-end">
                                                    <button type="button" wire:click="editOrder({{$moderator_order->id}})" class="btn btn-warning waves-effect waves-light right ms-auto">Update</button>
                                                </div>
                                            @endif
                                            <!--end col-->
