                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Pick up orders</h4>
                    ...
                    <div class="col-lg-12">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-6">
                                        <div class="row g-2">
                                            ...
                                            <div class="col-auto">
                                                <button type="buttom" wire:click="searchOrder" class="btn btn-primary btn-lg waves-effect waves-light"><i class="mdi mdi-magnify me-1"></i> Search</button>
                                            </div>
                                        </div>
                                    </div>
                                    <!--end col-->
                            ...
                            <div 
                                ...
                                <div class="tab-pane" id="pills-finish" role="tabpanel" aria-labelledby="pills-finish-tab">
                                    <div class="text-center py-5">
                                        ...
                                        <p style="font-size: 16px; font-weight: 400">The order has picked up</p>
                        ...
                        @if ($order)
                            ...
                            <div class="d-grid gap-2" >
                                <button class="btn btn-primary btn-border" id="pick_up_button" onclick="document.getElementById('orderCode').focus()" type="button" wire:click="pick_up_the_order">Pick Up</button>
                            </div>
