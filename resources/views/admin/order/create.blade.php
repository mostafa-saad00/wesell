    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <form action="{{ route('admin.product.store') }}" method="POST" id="createproduct-form" >
                    @csrf
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="description" id="description" rows="8" placeholder="Describe the product here..." required></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="product-title-input">Assigned user by email (optional) <span style="color: red">"if private product"</span></label>
                                        <input type="text" name="assigned_user" class="form-control" id="product-assigned-user-input" value="" placeholder="Enter assigned user email (optional)" >
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="is_published" id="choices-publish-status-input">
